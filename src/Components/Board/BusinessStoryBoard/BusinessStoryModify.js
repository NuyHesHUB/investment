...
const BusinessStoryModify = () => {
  ...
  useEffect(() => {
    axios.get(`${baseURL}/v1/board/free/post/${id}`, { headers }).then((res) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (window.confirm("수정하시겠습니까?")) {
      await axios.patch(`${baseURL}/v1/board/free/post/${id}`, postData, { headers }).then((res) => {
        alert("수정하였습니다")
...
export default BusinessStoryModify;